...
title='Calculated diffusion [mpa.s]'
title1='RF Predicted diffusion [mpa.s]'
...
plt.legend(labels=["Training data","Test data"],loc="lower right",fontsize=18, frameon=False) 
title='Calculated diffusion [mpa.s]'
title1='KRR Predicted diffusion [mpa.s]'
plt.xlabel(title,font1)
plt.ylabel(title1,font1)
plt.xlim((5, 44))
plt.ylim((5, 44))
...
plt.legend(labels=["Training data","Test data"],loc="lower right",fontsize=18, frameon=False) 
title='Calculated diffusion [mpa.s]'
title1='MLP Predicted diffusion [mpa.s]'
plt.xlabel(title,font1)
plt.ylabel(title1,font1)
plt.xlim((5, 44))
plt.ylim((5, 44))
...
plt.legend(labels=["Training data","Test data"],loc="lower right",fontsize=18, frameon=False) 
title='Calculated diffusion [mpa.s]'
title1='XGboost Predicted diffusion [mpa.s]'
plt.xlabel(title,font1)
plt.ylabel(title1,font1)
plt.xlim((5, 44))
plt.ylim((5, 44))
